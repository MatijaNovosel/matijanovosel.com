  ...
  <div class="offset">
    ...
    <ul>
      ...
      <li>
        ...
        or any other device by a website or application, containing the details
        of Your browsing history on that website or application among its many
        uses.
      </li>
      ...
      <li>Application refers to {{ appName }}</li>
      <li>
        You means the individual accessing or using the Service, or the company,
        or other legal entity on behalf of which such individual is accessing or
        using the Service, as applicabl
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        ...
        and for other related Application statistics (for example, recording the
    ...
    <ul>
      <li>
        ...
        <p>
          ...
          available through the Application and to enable You to use some of its
      ...
      <li>
        ...
        <p>
          ...
          use the Application, such as remembering your login details or
    ...
    <ul>
      ...
      <li>o manage Your requests: To attend and manage Your requests to Us.</li>
      <li>
    ...
    <ul>
      <li>By email: mnovosel5@gmail.com</li>
    </ul>
  </div>
</template>
...
h2 {
  @apply text-lg md:text-2xl my-3 text-gray-300;
}

h3 {
  @apply text-lg md:text-xl my-3 text-gray-300;
}
